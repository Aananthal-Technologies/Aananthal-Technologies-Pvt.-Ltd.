...
const serviceData = {
    ...
    '05': { icon: 'bolt', num: '05', title: 'Industrial Drives & Automation', tagline: 'Industrial intelligence, precision-engineered.', desc: 'Our embedded and hardware engineers deliver specialised automation solutions for manufacturing and industrial clients. We design, configure, and deploy Industrial Drive Systems that reduce energy consumption, extend motor life, and enable predictive maintenance through real-time AI-driven monitoring.', deliverables: ['Hardware specification & BOM', 'Industrial drive control software', 'Energy efficiency audit report', 'Remote monitoring dashboard', 'Maintenance documentation & SOP'], timeline: '3–8 weeks', cta: 'Automate Your Plant' },
...
window.toggleFaq = function (btn) {
    ...
    document.querySelectorAll('.faq-item.open').forEach(el => {
        ...
        el.querySelector('.faq-icon').textContent = 'add';
    });
    if (!isOpen) {
        item.classList.add('open');
        btn.querySelector('.faq-icon').textContent = 'remove';
    }
};
